<%@ Page Title="" Language="C#" MasterPageFile="~/SSLSite.Master" AutoEventWireup="true" CodeBehind="BasketDeliveryAddress.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.Basket.BasketDeliveryAddress" %>
<%@ Register src="~/Controls/LeftContainerControl.ascx" tagname="LeftContainerControl" tagprefix="uc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title><%=Languages.LanguageStrings.DeliveryAddress %> - <%=Languages.LanguageStrings.HeavenShoppingBag %> - <%=GetWebTitle()%></title>
</asp:Content>
