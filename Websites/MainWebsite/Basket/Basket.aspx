<%@ Page Language="C#" validaterequest="false" MasterPageFile="~/SSLSite.Master" AutoEventWireup="true" CodeBehind="Basket.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.Basket.PageBasket" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
        <div class="content">
            ...
            <div id="divMessage" runat="server" class="accountUpdated" style="margin-bottom: 50px;">
                <p><%=GetBasketMessage() %></p>
            </div>
			...
			<table width="940px" border="0" cellspacing="0" cellpadding="0" class="tblBasket" id="tblBasket" runat="server">
                ...
                <tr class="totals" id="tdSpacer" runat="server"><td>&nbsp;</td></tr>
                <tr class="voucher" id="trGiftWrap" runat="server">
                    <td colspan="3" class="voucher" id="tdGiftWrapMessage" runat="server">
                        
                    </td>
                    <td colspan="4" class="voucher">
