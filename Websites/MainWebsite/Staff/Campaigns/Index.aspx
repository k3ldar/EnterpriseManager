<%@ Page Title="" Language="C#" MasterPageFile="~/SiteStaff.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.Staff.Campaigns.Index" %>
		...
		<div class="content">
			...
			<div class="mainContentStaff">
                ...
                <asp:Table ID="tblCampaigns" runat="server" Width="100%" CssClass="tblSalesLeads" BorderWidth="0px">
                    ...
                    <asp:TableHeaderCell>Statistics</asp:TableHeaderCell>
                    </asp:TableHeaderRow>
                </asp:Table>
