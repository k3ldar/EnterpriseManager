...
namespace Heavenskincare.WebsiteTemplate.Staff.Reports.MonthToDate
{
    public partial class MonthToDateSalonOwners : BaseWebFormStaff
    {
        ...
        void statistics_OnInvoiceMonthToDateSalonOwners(object sender, Library.BOL.Statistics.Statistics.InvoiceMonthToDateArgs e)
        {
            if (_lastOwner != e.Country || _cellCount == 24)
            {
                ...
                Heavenskincare.WebsiteTemplate.Controls.MonthToDate newMTD = LoadControl("~/Staff/Controls/MonthToDate.ascx") as Heavenskincare.WebsiteTemplate.Controls.MonthToDate;
