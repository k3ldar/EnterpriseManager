<%@ Page Title="" Language="C#" MasterPageFile="~/SiteStaff.Master" AutoEventWireup="true" CodeBehind="MonthToDateBySalon.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.Staff.Statistics.MonthToDateBySalon1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
		<div class="content">
			...
			<div class="mainContentStaff">
                ...
                <h1>Top 10 Salons by Sales</h1>

			    <p>
                The following charts shows Sales for the last 12 Months by Top 10 Salons, the difference between current and previous year in £ and percent.
                </p>
