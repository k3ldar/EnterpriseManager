<%@ Page Title="" Language="C#" MasterPageFile="~/SiteStaff.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.WebsiteReports.Index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
		<div class="content">
			...
			<div class="mainContentStaff">
                ...
                <p>Current SEO Data</p>
                <p><a href="/Staff/Reports/SEO/Index.aspx">SEO Report</a></p>
                <p><a href="/Staff/Reports/SEO/SEOBasicStats.aspx">SEO Basic Statistics</a></p>
                <p>The following report will show products without SEO data</p>
                <p><a href="/Staff/Reports/MetaStatistics.aspx">Missing SEO Meta Data Report</a></p>
                ...
                <p><a href="/Staff/Reports/MonthToDate/MonthToDateByYear.aspx">Sales Month To Date By Year</a></p>
                <p><a href="/Staff/Reports/MonthToDate/MonthToDateTop5.aspx">Sales Month To Date - Top 5 Countries</a></p>
                <p><a href="/Staff/Reports/MonthToDate/MonthToDateTop10.aspx">Sales Month To Date - Top 10 Countries</a></p>
