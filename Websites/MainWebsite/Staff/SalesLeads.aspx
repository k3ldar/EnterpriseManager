<%@ Page Title="" Language="C#" MasterPageFile="~/SiteStaff.Master" AutoEventWireup="true" CodeBehind="SalesLeads.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.Staff.SalesLeads" %>
    ...
    <asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server" BackgroundCssClass="ModalPopupBG" DropShadow="true" PopupControlID="pnlSignupNotes" TargetControlID="hlHidden" OkControlID="btnSignupNotesOk">
		...
		<div class="content">
			...
			<div class="mainContentStaff">
                ...
                <p>Client Type:
				<asp:DropDownList ID="cmbClientType" runat="server">
