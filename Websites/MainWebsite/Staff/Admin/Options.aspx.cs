...
namespace Heavenskincare.WebsiteTemplate.Staff.Admin
{
    public partial class Options : BaseWebFormAdmin, WebsiteOptions
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            HeavenWebsiteSettings settings = new HeavenWebsiteSettings();
        ...
        private string GetWebsiteSubOptions(HeavenWebsiteSettings settings, string selectedOption, 
        ...
        private string GetWebsiteOptions(HeavenWebsiteSettings settings, string currentOption)
        {
            string Result = String.Empty;
        ...
        {
            EditSettingsText settings = (EditSettingsText)LoadControl("~/Staff/Controls/EditSettingsText.ascx");
            settings.UpdateSetting(name, value, description, reference, 250, isGlobal);
            divOptions.Controls.Add(settings);
        }
