    ...
    public partial class ViewSalon : System.Web.UI.UserControl
    {
        ...
        private string BuildSalon(Salon salon, double Distance)
        {
            ...
            if (!img.StartsWith("http://"))
                img = "http://www.heavenskincare.com" + img;

            Result += String.Format("<div class=\"salonImg\"><img src=\"{0}\" alt=\"{1}\" width=\"130\" /></div>", String.IsNullOrEmpty(salon.Image) ? "http://www.heavenskincare.com/images/Salons/no-salon.png" : img, salon.Name);
