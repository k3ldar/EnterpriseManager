...
namespace Heavenskincare.WebsiteTemplate.Controls
{
    public partial class FileUpload1 : BaseControlClass
    {
        ...
        {
            bool Result = false;
            string rootPath = String.Format("{0}Download\\Trade\\Temp\\", Global.Path);
        ...
        protected void btnNext_Click(object sender, EventArgs e)
        {
            ...
            string rootPathSource = String.Format("{0}Download\\Trade\\Temp\\", Global.Path);
            string rootPathDestination = String.Format("{0}download\\trade\\", Global.Path);
