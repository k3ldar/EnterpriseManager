<%@ Page Title="" Language="C#" MasterPageFile="~/SiteStaff.Master" AutoEventWireup="true"
    CodeBehind="Twitter.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.WebsiteFeeds.Twitter" %>
    ...
    <div class="content">
        ...
        <div class="mainContentStaff">
            ...
            <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Visible="true"
                ...
                <asp:TabPanel ID="TabPanel6" runat="server" HeaderText="deborah mitchell">
                    <ContentTemplate>
                        <a class="twitter-timeline" href="https://twitter.com/search?q=deborah+mitchell"
                            data-widget-id="393998685064806400">Tweets about "deborah mitchell"</a>
                        <script>                            !function (d, s, id) { var js, fjs = d.getElementsByTagName(s)[0], p = /^http:/.test(d.location) ? 'http' : 'https'; if (!d.getElementById(id)) { js = d.createElement(s); js.id = id; js.src = p + "://platform.twitter.com/widgets.js"; fjs.parentNode.insertBefore(js, fjs); } } (document, "script", "twitter-wjs");</script>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="bee venom">
                    <ContentTemplate>
                        <a class="twitter-timeline" href="https://twitter.com/search?q=bee+venom" data-widget-id="394002284247404544">
                            Tweets about "bee venom"</a>
                        <script>                            !function (d, s, id) { var js, fjs = d.getElementsByTagName(s)[0], p = /^http:/.test(d.location) ? 'http' : 'https'; if (!d.getElementById(id)) { js = d.createElement(s); js.id = id; js.src = p + "://platform.twitter.com/widgets.js"; fjs.parentNode.insertBefore(js, fjs); } } (document, "script", "twitter-wjs");</script>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="TabPanel3" runat="server" HeaderText="bee venom mask">
                    <ContentTemplate>
                        <a class="twitter-timeline" href="https://twitter.com/search?q=deborah+mitchell"
                ...
                <asp:TabPanel ID="TabPanel4" runat="server" HeaderText="heaven skin care">
                    <ContentTemplate>
                        <a class="twitter-timeline" href="https://twitter.com/search?q=heaven+skin+care"
