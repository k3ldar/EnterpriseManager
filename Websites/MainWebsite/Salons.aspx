<%@ Page Language="C#" validaterequest="false" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Salons.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.PageSalons" %>
        ...
        <div class="content">
			...
			<div class="breadcrumb">
				...
				<ul class="fixed">
					...
					<li>&rsaquo;</li>
					<li><a href="/Salons.aspx"><%=Languages.LanguageStrings.Salons %></a></li>
				</ul>
			...
			<div class="mainContent">
				...
				<div class="pagination">
					<ul class="fixed">
                        <%=BuildPagination(Library.BOL.Salons.Salons.GetCount(), 6, GetFormValue("Page", 1), "/Salons.aspx")%>
					</ul>
