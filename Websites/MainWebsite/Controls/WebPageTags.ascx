<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebPageTags.ascx.cs" Inherits="Heavenskincare.WebsiteTemplate.Controls.WebPageTags" %>
<div class="hashTags">
    ...
    <table id="tblTagManager" runat="server" class="hashTagsTable" width="100%">
        <tr><th colspan="3">SEO: Manage META&nbsp; Tags &amp; Description</th></tr>
        <tr>
            <td>Add Tags</td>
            <td>
        ...
        <tr id="trError" runat="server">
            <td>Error</td>
            <td colspan="2" id="tdError" runat="server" class="hashTagError"></asp:TextBox></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr><td>&nbsp;</td></tr>
        <tr><td>Embedable HTML</td></tr>
        <tr><td colspan="3">
            <asp:textbox runat="server" id="txtEmbedCode" style="width: 90%" MaxLength="999" Rows="6" TextMode="MultiLine"></asp:textbox></td></tr>
    </table>
</div>
