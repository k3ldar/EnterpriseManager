...
namespace Heavenskincare.WebsiteTemplate.Controls
{
    public partial class TradeSignup2 : BaseControlClass
    {
        ...
        protected void btnNext_Click(object sender, System.EventArgs e)
        {
            try
            {
                    ValidateDetails(HSCUtils.ReplaceHTMLElements(txtRooms.Text), 0, Languages.LanguageStrings.TradeSignupPage2A);
                    ValidateDetails(HSCUtils.ReplaceHTMLElements(txtHear.Text), 0, Languages.LanguageStrings.TradeSignupPage2B);
                    ValidateDetails(HSCUtils.ReplaceHTMLElements(txtSpecialise.Text), 0, Languages.LanguageStrings.TradeSignupPage2C);
                    ValidateDetails(HSCUtils.ReplaceHTMLElements(txtRooms.Text), 0, Languages.LanguageStrings.TradeSignupPage2D);
                    ValidateDetails(HSCUtils.ReplaceHTMLElements(txtTherapists.Text), 0, Languages.LanguageStrings.TradeSignupPage2E);
                    ValidateDetails(HSCUtils.ReplaceHTMLElements(txtTrading.Text), 0, Languages.LanguageStrings.TradeSignupPage2F);
                    ValidateDetails(HSCUtils.ReplaceHTMLElements(txtTreatments.Text), 0, Languages.LanguageStrings.TradeSignupPage2G);
                    RaiseNextPage(2);
            }
