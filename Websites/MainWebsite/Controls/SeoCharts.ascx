<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SeoCharts.ascx.cs" Inherits="Heavenskincare.WebsiteTemplate.Controls.SeoCharts" %>
...
<div class="content">
    ...
    <div id="divRawData" runat="server">
        <asp:Table ID="tblRawData" runat="server" Width="100%" CssClass="tblSalesLeads" BorderWidth="0px">
            <asp:TableHeaderRow>
