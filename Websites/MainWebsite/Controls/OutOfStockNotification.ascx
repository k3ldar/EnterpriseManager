<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OutOfStockNotification.ascx.cs" Inherits="Heavenskincare.WebsiteTemplate.Controls.OutOfStockNotification" %>
