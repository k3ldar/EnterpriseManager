<%@ Page Language="C#" validaterequest="false" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.Helpdesk.PageIndex" %>
		...
		<div class="content">
			...
			<div class="mainContent">
				...
				<ul class="helpOptions memberOptions fixed">
                    ...
                    <li class="feedback"><a href="/Helpdesk/Feedback.aspx"><%=Languages.LanguageStrings.Feedback %></a></li>
				</ul>
