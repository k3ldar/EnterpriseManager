<%@ Page Title="" Language="C#" ValidateRequest="false" MasterPageFile="~/SSLSite.Master" AutoEventWireup="true" CodeBehind="SpecialOffers.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.Offers.SpecialOffers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title><%=Languages.LanguageStrings.SpecialOffers %> - <%=GetWebTitle()%></title>
    ...
    <div class="content">
        <div class="breadcrumb">
            <ul class="fixed">
                ...
                <li>&rsaquo;</li>
                <li><a href="/Offers/SpecialOffers.aspx"><%=Languages.LanguageStrings.SpecialOffers %></a></li>
            </ul>
        </div>
        <!-- end of #breadcrumb -->
        <uc1:LeftContainerControl ID="LeftContainerControl1" runat="server" ShowCampaign="false" />

        <div class="binMainContent" id="divMainContent" runat="server">
            <h1><%=Languages.LanguageStrings.SpecialOffers %></h1>
