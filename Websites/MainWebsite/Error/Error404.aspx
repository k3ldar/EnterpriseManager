<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Error404.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.Error.Error404" %>

<%@ Register Src="~/Controls/LeftContainerControl.ascx" TagName="LeftContainerControl" TagPrefix="uc1" %>

<%@ Register Src="../Controls/BuyItNowStratosphere.ascx" TagName="BuyItNowStratosphere" TagPrefix="uc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <div class="content">
        ...
        <div class="mainContent">
            ...
            <p>
                <uc2:BuyItNowStratosphere ID="BuyItNowStratosphere1" runat="server" UseProductName="true" ProductID="1858" Image="http://static.heavenskincare.com/images/products/SILVER_BEE_VENOM_MASK_178.png" />
                </p>
