<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="Error.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.Error.Error" %>
...
<head>
    ...
    <title>Unexpected Error - Heaven Health & Beauty Ltd - Heaven Skin Care for healthy skin, mind, body and soul.</title>
...
<body>
                    ...
                    <div class="countrySelection">
                        <ul>
                            <li style="line-height:2.0em; width: 600px;">
                                We are really sorry, an unexpected error in the website occurred, the webmaster has been informed and hopefully this will be resolved soon.
                            </li>
                            <li style="line-height:2.0em; width: 600px;">
                                If you continue to experience difficulties, please call our office on +44(0) 1952 462505 or +44(0) 1952 463574 to place an order.
                            </li>
                        </ul>
                    </div>
        ...
        <div class="footer png_bg">
            ...
            <p>
                <a href="mailto:sales@WebsiteTemplate.com">sales@WebsiteTemplate.com</a> 
            </p>
