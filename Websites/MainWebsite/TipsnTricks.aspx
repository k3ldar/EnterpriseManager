<%@ Page Language="C#" validaterequest="false" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TipsnTricks.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.TipsnTricks" %>
		...
		<div class="content">
			...
			<div class="mainContent">
				...
				<div class="pagination">
					<ul class="fixed">
						 <%=BuildPagination(Library.BOL.TipsTricks.TipsTricks.GetCount(), 1, GetFormValue("Page", 1), "/TipsnTricks.aspx")%>
					</ul>
