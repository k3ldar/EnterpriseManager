<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.Appointments.Index" %>
        ...
        <div class="content">
			...
			<div class="breadcrumb">
				...
				<ul class="fixed">
					...
					<li>&rsaquo;</li>
                    <li><a href="/Appointments/Index.aspx"><%=Languages.LanguageStrings.BookSalonAppointment %></a></li>
				</ul>
			...
			<div class="mainContent">
				...
				<h1><%=Languages.LanguageStrings.BookSalonAppointment %></h1>
				
                <p id="divContactDetails" runat="server">
