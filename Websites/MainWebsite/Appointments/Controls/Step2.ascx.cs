...
namespace Heavenskincare.WebsiteTemplate.Appointments.Controls
{
    public partial class Step2 : BaseControlClass
    {
        ...
        private void LoadTherapists()
        {
            ...
            lstTherapist.Items.Add(new ListItem(Languages.LanguageStrings.AnyTherapist, "-1"));
        ...
        private void LoadStartTimes()
        {
            ...
            {
                ListItem item = new ListItem(Shared.Utilities.DoubleToTime(t));
        ...
        public double SelectedTime
        {
            get
            {
                return (Shared.Utilities.TimeToDouble(lstStartTime.SelectedValue));
            }
        }
        ...
        protected void calDate_SelectionChanged(object sender, EventArgs e)
        {
            if (calDate.SelectedDate.Date < DateTime.Now.AddDays(1).Date || calDate.SelectedDate.DayOfWeek == DayOfWeek.Sunday)
            {
                ...
                lblError.Text = Languages.LanguageStrings.UnableBookCurrentPast;
            }
        }
