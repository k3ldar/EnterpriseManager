<%@ Page Title="" Language="C#" MasterPageFile="~/SSLSite.Master" AutoEventWireup="true" CodeBehind="InvoiceView.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.Members.InvoiceView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
        <div class="content">
			...
			<h1><%=Languages.LanguageStrings.ViewInvoice %></h1>
                ...
                <p id="pSubTotal" runat="server"><strong><%=Languages.LanguageStrings.SubTotal %></strong> <%=GetInvoiceSubtotal()%></p>
