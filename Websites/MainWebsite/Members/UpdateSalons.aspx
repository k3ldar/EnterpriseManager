<%@ Page Title="" Language="C#" MasterPageFile="~/SSLSite.Master" AutoEventWireup="true" CodeBehind="UpdateSalons.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.Members.UpdateSalons" %>
	...
	<div class="content">
		...
		<div class="breadcrumb">
			...
			<ul class="fixed">
				...
				<li>&rsaquo;</li>
				<li><a href="/Members/UpdateSalons.aspx"><%=Languages.LanguageStrings.UpdateSalonDetails %></a></li>
			</ul>
