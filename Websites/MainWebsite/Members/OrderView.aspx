<%@ Page Title="" Language="C#" MasterPageFile="~/SSLSite.Master" AutoEventWireup="true" CodeBehind="OrderView.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.Members.OrderView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
		<div class="content">
			...
			<h1><%=Languages.LanguageStrings.ViewOrder %></h1>
                ...
                <p id="pSubTotal" runat="server"><strong><%=Languages.LanguageStrings.SubTotal %></strong> <%=GetOrderSubtotal() %></p>
                ...
                <p><strong><%=Languages.LanguageStrings.Total2 %></strong> <%=GetOrderTotal() %></p>
