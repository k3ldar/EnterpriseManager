<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CompetitionRegistration.ascx.cs" Inherits="Heavenskincare.WebsiteTemplate.Members.Controls.CompetitionRegistration" %>
