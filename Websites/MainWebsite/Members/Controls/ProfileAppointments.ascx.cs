    ...
    public partial class ProfileAppointments : BaseControlClass
    {
        ...
        private void BuildAppointments()
        {
            ...
            foreach (Appointment appt in Library.BOL.Appointments.Appointments.Get(GetUser(), page, 10))
            {
                ...
                cApptDate.InnerText = Shared.Utilities.DateTimeToStr(appt.AppointmentAsDateTime(), WebCulture);
                ...
                r.Cells.Add(cStatus);
                cStatus.InnerText = Shared.Utilities.SplitCamelCase(appt.Status.ToString());
