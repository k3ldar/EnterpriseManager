...
namespace Heavenskincare.WebsiteTemplate.Members.Controls
{
    public partial class ProfileCreditCard : BaseControlClass
    {
        ...
        public bool ValidateDetails()
        {
            ...
            try
            {
                ...
                Library.BOL.Users.CreditCard newCard =
                    new Library.BOL.Users.CreditCard(-1, GetUser(), Library.Utils.StringCipher.Encrypt(cardNum, "Heaven@_13A"), cardNum.Substring(cardNum.Length - 4, 4),
                        cardValidFrom, cardValidTo, txtName.Text, txtLast3.Text, (AcceptedCreditCardTypes)Convert.ToInt32(ddlCardType.SelectedValue));
            ...
            {
                Global.SendEMail(Global.WebsiteEmail, Global.WebsiteEmail, "Credit Card Failed Validation", err.Message);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Global.CreditCardAlwaysShowValidFromForUK && GetCountry().CountryCode == "GB")
            {
            ...
            {
                lblValidFrom.Visible = !Global.CreditCardHideValidFrom;
                ddlFromYear.Visible = !Global.CreditCardHideValidFrom;
                ddlFromMonth.Visible = !Global.CreditCardHideValidFrom;
            }
        ...
        private void LoadDetails()
        {
            ...
            ddlCardType.Items.Add(new ListItem("VisaDebit", "4"));
