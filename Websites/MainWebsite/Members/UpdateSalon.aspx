<%@ Page Title="" Language="C#" MasterPageFile="~/SSLSite.Master" AutoEventWireup="true" CodeBehind="UpdateSalon.aspx.cs" Inherits="Heavenskincare.WebsiteTemplate.Members.UpdateSalon" %>

<%@ Register src="~/Controls/LeftContainerControl.ascx" tagname="LeftContainerControl" tagprefix="uc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title><%=Languages.LanguageStrings.UpdateSalons %> - <%=Languages.LanguageStrings.MyAccount %> - <%=GetWebTitle()%></title>
        ...
        <div class="content">
			...
			<div class="breadcrumb">
				...
				<ul class="fixed">
					...
					<li>&rsaquo;</li>
					<li><a href="/Members/UpdateSalons.aspx"><%=Languages.LanguageStrings.UpdateSalons %></a></li>
					<li>&rsaquo;</li>
					<li><a href="/Members/UpdateSalon.aspx?SalonID=<%=GetSalonID() %>"><%=Languages.LanguageStrings.UpdateSalonDetails %></a></li>
				</ul>
			...
			<div class="mainContent">
				...
				<h1><%=Languages.LanguageStrings.UpdateSalonDetails %></h1>
				
                <p><%=Languages.LanguageStrings.UpdateSalonDetailsDescription1 %></p>
				<p><%=Languages.LanguageStrings.UpdateSalonDetailsDescription2 %></p>
            ...
            <p class="TextBodySmall"><%=Languages.LanguageStrings.UpdateSalonDetailsDescription3 %>* </p>
