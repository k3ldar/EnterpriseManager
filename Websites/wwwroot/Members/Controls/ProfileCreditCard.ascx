<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProfileCreditCard.ascx.cs" Inherits="SieraDelta.Website.Members.Controls.ProfileCreditCard" %>
<div id="dMain" runat="server" class="content form">
    ...
    <label><%=Languages.LanguageStrings.ValidFrom %></label>
