		...
		<div class="content">
			...
			<div class="breadcrumb">
				...
				<ul class="fixed">
					...
					<li>&rsaquo;</li>
					<li><a href="/Account/Help-Desk/Tickets/"><%=Languages.LanguageStrings.MySupportTickets %></a></li>
				</ul>
			...
			<div class="mainContent">
                ...
                <div class="pagination">
					<ul class="fixed">
						 <%=BuildPagination(SupportTicketCount(), 10, GetSupportTicketPage(), "/Account/Help-Desk/Tickets/", true)%>
					</ul>
