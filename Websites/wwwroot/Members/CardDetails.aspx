<%@ Page Title="" Language="C#" MasterPageFile="~/SSLSite.Master" AutoEventWireup="true" CodeBehind="CardDetails.aspx.cs" Inherits="SieraDelta.Website.Members.CreditCard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
		<div class="content">
			...
			<div class="mainContent">
                ...
                <p>&nbsp;</p><p>&nbsp;</p>
                <p>SieraDelta.com accepts payment by a variety of methods including Visa, Mastercard and Paypal.</p>
                ...
                <p>This is why we have all the security protocols that protect you and allow you to make secure purchases on SieraDelta.com. </p>
