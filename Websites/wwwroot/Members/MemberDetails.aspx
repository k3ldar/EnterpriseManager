<%@ Page Title="" Language="C#" MasterPageFile="~/SSLSite.Master" AutoEventWireup="true" CodeBehind="MemberDetails.aspx.cs" Inherits="SieraDelta.Website.Members.MemberDetails" %>
		...
		<div class="content">
			...
			<div class="breadcrumb">
				...
				<ul class="fixed">
					...
					<li>&rsaquo;</li>
					<li><a href="/Account/Details/"><%=Languages.LanguageStrings.MemberDetails %></a></li>
				</ul>
