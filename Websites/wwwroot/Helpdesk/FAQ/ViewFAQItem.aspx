<%@ Page Title="" Language="C#" MasterPageFile="~/SSLSite.Master" AutoEventWireup="true" CodeBehind="ViewFAQItem.aspx.cs" Inherits="SieraDelta.Website.Helpdeks.FAQ.ViewFAQItem" %>
		...
		<div class="content">
			...
			<div class="breadcrumb">
				...
				<ul class="fixed">
					...
					<li>&rsaquo;</li>
					<li><a href="/Help-Desk/FAQ/Index.aspx"><%=Languages.LanguageStrings.FrequentlyAskedQuestions %></a></li>
					<li>&rsaquo;</li>
                    <%=GroupBreadCrumb() %>
				</ul>
