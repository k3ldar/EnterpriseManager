<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LeaveFeedback.ascx.cs" Inherits="SieraDelta.Helpdesk.Controls.LeaveFeedback" %>
...
<div class="content form">
                ...
                <label><%=Languages.LanguageStrings.Comments %></label><asp:TextBox ID="txtComments" runat="server" TextMode="MultiLine" MaxLength="5000"></asp:TextBox><br />
