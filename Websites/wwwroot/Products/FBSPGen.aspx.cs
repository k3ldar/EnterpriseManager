...
{
    public partial class FBSPGen : BaseWebFormProduct
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Product = Library.BOL.Products.Products.Get(6);
            ...
            Library.BOL.Downloads.Download downloadFile = Library.BOL.Downloads.Downloads.Get(5, 0);
