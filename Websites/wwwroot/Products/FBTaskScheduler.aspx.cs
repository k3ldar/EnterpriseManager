...
{
    public partial class FBTaskScheduler : BaseWebFormProduct
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Product = Library.BOL.Products.Products.Get(7);
            ...
            if (!AllowShowCostData() || !ShowPriceData || Product.FreeProduct)
            {
            ...
            //translated data
            UpdateCustomTranslatedPageData("Firebird Task Scheduler", divFeaturesTranslated);
            UpdateCustomTranslatedPageData("Firebird Task Scheduler Description", divDescriptionTranslated);

            Library.BOL.Downloads.Download downloadFile = Library.BOL.Downloads.Downloads.Get(6, 0);
        ...
        {
            if (BaseWebApplication.OutOfStockAllowNotifyUser && 
                BaseWebApplication.OutOfStockInPage && 
