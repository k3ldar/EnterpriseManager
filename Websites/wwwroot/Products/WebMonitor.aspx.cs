...
{
    public partial class WebMonitor : BaseWebFormProduct
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Product = Library.BOL.Products.Products.Get(2);
            ...
            //translated data
            UpdateCustomTranslatedPageData("WebMonitor Features", divFeaturesTranslated);
            UpdateCustomTranslatedPageData("WebMonitor Description", divDescriptionTranslated);
        }
        ...
        {
            if (BaseWebApplication.OutOfStockAllowNotifyUser && BaseWebApplication.OutOfStockInPage && lstProductTypes.SelectedIndex > -1)
            {
                //SieraDeltaUtils u = new SieraDeltaUtils();
                int prodType = SharedUtils.StrToIntDef(lstProductTypes.SelectedItem.Value, -1);
