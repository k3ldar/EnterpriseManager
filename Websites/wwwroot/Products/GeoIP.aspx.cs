...
{
    public partial class GeoIP : BaseWebFormProduct
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Product = Library.BOL.Products.Products.Get(8);
            ...
            //translated data
            UpdateCustomTranslatedPageData("WebDefender Server Features", divFeaturesTranslated, false);
            UpdateCustomTranslatedPageData("WebDefender Server Description", divDescriptionTranslated, false);

            Library.BOL.Downloads.Download downloadFile = Library.BOL.Downloads.Downloads.Get(8, 0);
            FileDownload1.Refresh(downloadFile);

            pGeoIPVersion.InnerText = String.Format("The latest version of GeoIP data is version {0}, last updated {1}.", 
                BaseWebApplication.GeoIPLatestVersion, 
                Shared.Utilities.FormatDate(BaseWebApplication.GeoIPLastUpdated, 
                System.Threading.Thread.CurrentThread.CurrentUICulture.Name, "d"));
        }
