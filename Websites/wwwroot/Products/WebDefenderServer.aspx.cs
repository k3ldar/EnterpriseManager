...
{
    public partial class WebDefenderServer : BaseWebFormProduct
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //translated data
            UpdateCustomTranslatedPageData("WebDefender Server Features", divFeaturesTranslated);
            UpdateCustomTranslatedPageData("WebDefender Server Description", divDescriptionTranslated);
        }
