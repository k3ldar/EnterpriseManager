...
{
    public partial class WebDefenderWebsite : BaseWebFormProduct
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Product = Library.BOL.Products.Products.Get(3);
            ...
            //translated data
            UpdateCustomTranslatedPageData("WebDefender Website Features", divFeaturesTranslated);
            UpdateCustomTranslatedPageData("WebDefender Website Description", divDescriptionTranslated);
        }
