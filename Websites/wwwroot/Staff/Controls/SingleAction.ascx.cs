...
namespace SieraDelta.Website.Controls
{
    public partial class SingleAction : BaseControlClass
    {
        ...
        {
            string sTitle ="";
            string ActionBy = clientAction.User == null ? clientAction.StaffName : clientAction.User.UserName;
            DateTime ActionDate = clientAction.User == null ? clientAction.Expires : clientAction.ActionedDate;
            ...
            cellDescription.Text = String.Format("{0} {1} - Staff: {2}; {4}: {3}", clientAction.User == null ? "" : "<img src=\"/images/tick.jpg\" align=\"left\" border=\"0\" width=\"50\" height=\"50\" />",
                sTitle, ActionBy, ActionDate.ToString("dd/MM/yyyy"), clientAction.User == null ? "Expires" : "Actioned");
