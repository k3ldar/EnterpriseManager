...
namespace SieraDelta.Website.Statistics
{
    public partial class Charts : BaseWebFormStaff
    {
        ...
        void _statistics_OnInvoiceMonthToDateTop5(object sender, Library.BOL.Statistics.Statistics.InvoiceMonthToDateArgs e)
        {
            if (!_lastResults)
            {
                ...
                {
                    Library.BOL.Mail.Emails.Add("s1cart3r@gmail.com", "Simon", "heaven", "noreply@SieraDelta.com", "Error _statistics_OnInvoiceMonthToDateTop5",
