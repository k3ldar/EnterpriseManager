...
namespace SieraDelta.WebsiteTemplate.Website.Appointments.Controls
{
    public partial class Step3 : BaseControlClass
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            btnTryAgain.Text = SieraDelta.Languages.LanguageStrings.TryAgain;
        }
        ...
        public void FindAppointment()
        {
            ...
            if (count == 0)
            {
                lblError.Text = String.Format(SieraDelta.Languages.LanguageStrings.CouldNotBookAppointment, 
