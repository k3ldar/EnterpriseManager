<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Terms.ascx.cs" Inherits="SieraDelta.Website.Appointments.Controls.Terms" %>
<h3>
    <%=SieraDelta.Languages.LanguageStrings.TermsAndConditions %></h3>
<h5>
    <%=SieraDelta.Languages.LanguageStrings.Appointments %></h5>
<p>
...
<h5>
    <%=SieraDelta.Languages.LanguageStrings.Smoking %></h5>
<p>
