<%@ Page Language="C#" validaterequest="false" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Tip.aspx.cs" Inherits="SieraDelta.Website.Tips.PageTip" %>
		...
		<div class="content">
			...
			<div class="mainContent">
				...
				<div class="pagination">
					<ul class="fixed">
						 <%=BuildPagination(SieraDelta.Library.BOL.TipsTricks.TipsTricks.GetCount(), 1, GetFormValue("Page", 1), "/Tips/Tip.aspx")%>
					</ul>
