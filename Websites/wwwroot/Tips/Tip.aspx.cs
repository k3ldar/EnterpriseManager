...
{
    public partial class PageTip : BaseWebForm
    {
        private TipsTrick _tip;

        protected void Page_Load(object sender, EventArgs e)
        {
            LeftContainerControl1.SubHeader = SieraDelta.Languages.LanguageStrings.Categories;
            LeftContainerControl1.SubOptions = GetProductCategories(Enums.PrimaryProductType.Professional);
