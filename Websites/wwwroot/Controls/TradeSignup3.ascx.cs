...
namespace SieraDelta.Website.Controls.Controls
{
    public partial class TradeSignup3 : BaseControlClass
    {
        ...
        protected void btnNext_Click(object sender, System.EventArgs e)
        {
            try
            {
                ValidateDetails(SharedUtils.ReplaceHTMLElements(txtClients.Text), 0, Languages.LanguageStrings.TradeSignupPage3A);
                ValidateDetails(SharedUtils.ReplaceHTMLElements(txtTreatments.Text), 0, Languages.LanguageStrings.TradeSignupPage3B);
                ValidateDetails(SharedUtils.ReplaceHTMLElements(txtProductsUse.Text), 0, Languages.LanguageStrings.TradeSignupPage3C);
                RaiseNextPage(3);
            }
