<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SeoPagePopup.ascx.cs" Inherits="SieraDelta.Website.Controls.SeoPagePopup" %>
...
<style>
	...
	.seoPopup .form { font-size: 1.3em; width: 580px; }
		...
		.seoPopup .form input[type="submit"] {
			...
			background-image: url('/images/btn_fallback.gif');
