<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BuyItNowStratosphere.ascx.cs" Inherits="SieraDelta.Website.Controls.BuyItNowStratosphere" %>
<div class="binProductImg">
    <div class="divImage">
        <a Name="#tag" id="hrAnchor" runat="server"><img src="/Images/Product/no-image.jpg" alt="Product Image" border="0"
