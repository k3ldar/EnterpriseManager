<%@ Control Language="C#" EnableViewState="true" AutoEventWireup="true" CodeBehind="CountryLanguageSelect.ascx.cs" Inherits="SieraDelta.Website.Controls.CountryLanguageSelect" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<div id="divPopupControl" runat="server" class="languageCurrencyBox">
    <%=GetLanguageCurrency() %>
</div>
