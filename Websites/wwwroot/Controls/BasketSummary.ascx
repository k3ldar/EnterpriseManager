<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BasketSummary.ascx.cs" Inherits="SieraDelta.Website.Controls.BasketSummary" %>
  ...
  <div id="basketSummary" runat="server" class="cartConfirm content" onmouseleave="HideSummaryDetails()">
    ...
    <div  class="cartItemDescription">
            <img src="/Images/Products/<%=GetProductImage()%>" alt="" border="0" width="89" height="64" align="left" />
