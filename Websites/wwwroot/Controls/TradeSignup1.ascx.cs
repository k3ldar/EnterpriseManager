        ...
        protected void btnNext_Click(object sender, System.EventArgs e)
        {
            try
            {
                if (VerificationImage1.IsValid)
                {
                    ...
                    ValidateDetails(SharedUtils.ReplaceHTMLElements(txtName.Text), 0, Languages.LanguageStrings.ContactName);
                    ValidateDetails(SharedUtils.ReplaceHTMLElements(txtCompany.Text), 0, Languages.LanguageStrings.CompanyName);
                    ValidateDetails(SharedUtils.ReplaceHTMLElements(txtTelephone.Text), 0, Languages.LanguageStrings.Telephone);
