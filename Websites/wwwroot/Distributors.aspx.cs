...
namespace SieraDelta.Website
{
    public partial class PageDistributors : BaseWebForm
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            UpdateCustomTranslatedPageData("Distributors", divTranslated, false);
        }
        ...
        protected int GetDistributorPageNumber()
        {
            return (SharedUtils.StrToIntDef(GetDistributorPage(), 1));
        }

        protected string GetDistributorPage()
        {
