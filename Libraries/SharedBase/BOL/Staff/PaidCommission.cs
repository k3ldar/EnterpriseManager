...
{
    [Serializable]
    public sealed class PaidCommission : BaseCollection
    {
        ...
        public PaidCommissionItem this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, PaidCommissionItem value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(PaidCommissionItem value)
        {
            List.Remove(value);
        }
        ...
        private const string OBJECT_TYPE = "SharedBase.BOL.Staff.PaidCommissionItem";
        private const string OBJECT_TYPE_ERROR = "Must be of type PaidCommissionItem";
