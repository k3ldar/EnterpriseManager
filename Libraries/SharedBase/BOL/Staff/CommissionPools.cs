...
{
    [Serializable]
    public sealed class CommissionPools : BaseCollection
    {
        ...
        public CommissionPool this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, CommissionPool value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(CommissionPool value)
        {
            List.Remove(value);
        }
        ...
        private const string OBJECT_TYPE = "SharedBase.BOL.Staff.CommissionPool";
        private const string OBJECT_TYPE_ERROR = "Must be of type CommissionPool";
