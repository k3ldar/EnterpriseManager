...
{
    [Serializable]
    public sealed class TrainingCourses : BaseCollection
    {
        #region Static Methods

        /// <summary>
        /// Retrieves an individual course based on it's ID
        /// </summary>
        /// <param name="id">ID of course to be returned</param>
        ...
        /// <returns>TrainingCourse object</returns>
        public TrainingCourse this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, TrainingCourse value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(TrainingCourse value)
        {
            List.Remove(value);
        }
        ...
        private const string OBJECT_TYPE = "SharedBase.BOL.Training.TrainingCourse";
        private const string OBJECT_TYPE_ERROR = "Must be of type TrainingCourse";
