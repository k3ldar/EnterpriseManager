...
{
    [Serializable]
    public sealed class Attendees : BaseCollection
    {
        #region Static Methods

        /// <summary>
        /// List of attending salons and current status
        /// </summary>
        /// <param name="course">Course object</param>
        /// <returns>Attendees collection</returns>
        public static Attendees Get(Course course)
        {
            return (DAL.FirebirdDB.TrainingCourseAttendeesGet(course));
        }
        ...
        /// <returns>Attendee object</returns>
        ...
        private const string OBJECT_TYPE = "SharedBase.BOL.Training.Attendee";
        private const string OBJECT_TYPE_ERROR = "Must be of type Attendee";
