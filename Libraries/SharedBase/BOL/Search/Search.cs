...
namespace SharedBase.BOL.Search
{
    [Serializable]
    public sealed class Search : BaseCollection
    {
        #region Static Methods

        /// <summary>
        /// Searches all database items 
        /// </summary>
        /// <param name="memberLevel">Member level of 
        /// 
        /// Individual words seperated by a space </param>
        ...
        /// <param name="value"></param>
        public void Insert(int index, SearchItem value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(SearchItem value)
        {
            List.Remove(value);
        }
        ...
        private const string OBJECT_TYPE = "SharedBase.BOL.Search.SearchItem";
        private const string OBJECT_TYPE_ERROR = "Must be of type SearchItem";
