...
{
    [Serializable]
    public sealed class Celebrities : BaseCollection
    {
        ...
        /// <returns></returns>
        public static Celebrity Create(string name, string description, string image)
        {
            int id = DAL.FirebirdDB.CelebrityCreate(name, description, image);
        ...
        public Celebrity this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, Celebrity value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(Celebrity value)
        {
            List.Remove(value);
        }
