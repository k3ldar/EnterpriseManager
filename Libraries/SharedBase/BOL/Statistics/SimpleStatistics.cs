...
{
    [Serializable]
    public sealed class SimpleStatistics : BaseCollection
    {
        ...
        /// </summary>
        public SimpleStatistic this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, SimpleStatistic value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(SimpleStatistic value)
        {
            List.Remove(value);
        }
