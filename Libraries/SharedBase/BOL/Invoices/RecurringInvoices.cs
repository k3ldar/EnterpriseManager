...
{
    public sealed class RecurringInvoices : BaseCollection
    {
        #region Static Methods

        public static RecurringInvoice Add(string description, User user, DateTime nextRun,
        ...
        public RecurringInvoice this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, RecurringInvoice value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(RecurringInvoice value)
        {
            List.Remove(value);
        }
        ...
        private const string OBJECT_TYPE = "SharedBase.BOL.Invoices.RecurringInvoice";
        private const string OBJECT_TYPE_ERROR = "Must be of type RecurringInvoice";
