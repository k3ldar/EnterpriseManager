...
namespace SharedBase.BOL.IPAddresses
{
    ...
    public sealed class IPAddresses : BaseCollection
    {
        ...
        public static IPAddresses Load()
        {
            ...
            //string fileName = SharedBase.Utils.LibUtils.CurrentPath(true) + "AddressList.Data";
        ...
        {
            throw new NotImplementedException();            //IPAddresses latestBanned = DAL.FirebirdDB.WebDefenderAddressGet(AddressType.FailedAudit, true, false);
        ...
        private const string OBJECT_TYPE = "SharedBase.BOL.IPAddresses.IPAddress";
