...
namespace SharedBase.BOL.MissingLinks
{
    [Serializable]
    public sealed class MissingLinks : BaseCollection
    {
        ...
        public MissingLink this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, MissingLink value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(MissingLink value)
        {
            List.Remove(value);
        }
