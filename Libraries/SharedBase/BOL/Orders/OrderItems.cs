...
{
    [Serializable]
    public sealed class OrderItems : BaseCollection
    {
        ...
        private const string OBJECT_TYPE = "SharedBase.BOL.Orders.OrderItem";
        private const string OBJECT_TYPE_ERROR = "Must be of type OrderItem";
