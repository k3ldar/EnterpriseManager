...
{
    [Serializable]
    public sealed class AppointmentStatuses : BaseCollection
    {
        ...
        public AppointmentStatus this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, AppointmentStatus value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(AppointmentStatus value)
        {
            List.Remove(value);
        }
        ...
        private const string OBJECT_TYPE = "SharedBase.BOL.Appointments.AppointmentStatus";
        private const string OBJECT_TYPE_ERROR = "Must be of type AppointmentStatus";
