...
{
    [Serializable]
    public sealed class AppointmentTypes : BaseCollection
    {
        ...
        public static AppointmentType Get(int appointmentType)
        {
        ...
        public AppointmentType this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, AppointmentType value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(AppointmentType value)
        {
            List.Remove(value);
        }
        ...
        private const string OBJECT_TYPE = "SharedBase.BOL.Appointments.AppointmentType";
        private const string OBJECT_TYPE_ERROR = "Must be of type AppointmentType";
