...
{
    [Serializable]
    public sealed class USStates : BaseCollection
    {
        ...
        /// <param name="value"></param>
        public void Insert(int index, USState value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(USState value)
        {
            List.Remove(value);
        }
        ...
        private const string OBJECT_TYPE = "SharedBase.BOL.USAStates.USState";
        private const string OBJECT_TYPE_ERROR = "Must be of type USState";
