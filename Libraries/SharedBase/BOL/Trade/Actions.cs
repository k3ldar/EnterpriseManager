...
{
    [Serializable]
    public sealed class ClientActions : BaseCollection
    {
        ...
        {
            foreach (ClientAction action in this)
            {
        ...
        public ClientAction this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, ClientAction value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(ClientAction value)
        {
            List.Remove(value);
        }
