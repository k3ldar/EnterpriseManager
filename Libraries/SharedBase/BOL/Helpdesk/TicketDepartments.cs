...
{
    [Serializable]
    public sealed class TicketDepartments : BaseCollection
    {
        ...
        public TicketDepartment this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, TicketDepartment value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(TicketDepartment value)
        {
            List.Remove(value);
        }
        ...
        private const string OBJECT_TYPE = "SharedBase.BOL.Helpdesk.TicketDepartment";
        private const string OBJECT_TYPE_ERROR = "Must be of type TicketDepartment";
