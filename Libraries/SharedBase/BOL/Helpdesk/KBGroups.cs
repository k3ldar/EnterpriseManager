...
{
    [Serializable]
    public sealed class KBGroups : BaseCollection
    {
        ...
        /// <summary>
        /// Retrieves all KB Groups, admin use only
        /// </summary>
        /// <returns></returns>
        ...
        /// <param name="value"></param>
        public void Insert(int index, KBGroup value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(KBGroup value)
        {
            List.Remove(value);
        }
        ...
        private const string OBJECT_TYPE = "SharedBase.BOL.Helpdesk.KBGroup";
        private const string OBJECT_TYPE_ERROR = "Must be of type KBGroup";
