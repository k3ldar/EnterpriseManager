...
namespace SharedBase.BOL.CashDrawer
{
    [Serializable]
    public sealed class CashDenominations : BaseCollection
    {
        #region Static Methods

        /// <summary>
        /// Returns all currency denominations for a country
        /// </summary>
        ...
        public CashDenomination this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, CashDenomination value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(CashDenomination value)
        {
            List.Remove(value);
        }
