...
{
    [Serializable]
    public sealed class ExportableItems : BaseCollection
    {
        ...
        /// <returns>ExportItem object</returns>
        public ExportItem this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, ExportItem value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(ExportItem value)
        {
            List.Remove(value);
        }
