...
{
    [Serializable]
    public sealed class WebVisitLogItems : BaseCollection
    {
        #region Generic CollectionBase Code

        #region Properties

        public WebVisitLogItem this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, WebVisitLogItem value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(WebVisitLogItem value)
        {
            List.Remove(value);
        }
