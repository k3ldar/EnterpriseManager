...
namespace SharedBase.BOL.Locations
{
    [Serializable]
    public sealed class Locations : BaseCollection
    {
        ...
        /// <summary>
        /// Returns an individual store location
        /// </summary>
        ...
        /// <returns>StoreLocation object</returns>
        public StoreLocation this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, StoreLocation value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(StoreLocation value)
        {
            List.Remove(value);
        }
        ...
        private const string OBJECT_TYPE = "SharedBase.BOL.Locations.StoreLocation";
        private const string OBJECT_TYPE_ERROR = "Must be of type StoreLocation";
