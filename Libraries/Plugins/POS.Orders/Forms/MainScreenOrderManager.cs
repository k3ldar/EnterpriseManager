...
{
    public partial class OrderDispatchControl : Base.Forms.BaseForm
    {
        ...
        {
            base.OnActivated(e);
            HelpTopic = POS.Base.Classes.HelpTopics.OrdersDispatch;
        }
        ...
        private void btnDispatch_Click(object sender, EventArgs e)
        {
            ...
            //update item status
            InvoiceDispatched id = new InvoiceDispatched(AppController.ActiveUser, _currentInvoice, _partialDispatch);
            try
            {
        ...
        private void MainScreenOrderManager_Shown(object sender, EventArgs e)
        {
            ...
            {
                Close();
                ShowInformation(LanguageStrings.AppOrderManager, LanguageStrings.AppInvoiceNoneToProcess);
        ...
        private void btnStaffNotes_Click(object sender, EventArgs e)
        {
            ...
            if (POS.Base.Forms.NotesViewForm.ShowNotes(this, ref notes, false, 32000))
