...
namespace POS.Staff.Controls.Settings
{
    public partial class ClientCommissionSettings : SharedControls.BaseSettings
    {
        ...
        {
            int months = Shared.Utilities.StrToIntDef(SharedBase.LibraryHelperClass.SettingsGet(StringConstants.COMMISSION_CLIENT_MONTHS, StringConstants.SYMBOL_THREE), 3);
            int minMonths = Shared.Utilities.StrToIntDef(SharedBase.LibraryHelperClass.SettingsGet(StringConstants.COMMISSION_CLIENT_MIN_WAiT, StringConstants.SYMBOL_TWO), 2);
