 ...
 *  
 *  File: CommissionPoolSettings.cs
 *
 *  Purpose:  
 *
 *  Date        Name                Reason
...
namespace POS.Staff.Controls.Settings
{
    public partial class CommissionPoolSettings : SharedControls.BaseSettings
    {
        ...
        public override bool SettingsSave()
        {
            ...
            {
                SharedBase.LibraryHelperClass.SettingsSet(StringConstants.COMMISSION_POOL_MONTHS, udMonthsToWait.Value.ToString());
            }
            else
            {
                ...
                SharedBase.LibraryHelperClass.SettingsSet(StringConstants.COMMISSION_POOL_MONTHS, m + d);
                SharedBase.LibraryHelperClass.SettingsSet(StringConstants.COMMISSION_POOL_MIN_WAiT, udMonthsToWait.Value.ToString());
            }
