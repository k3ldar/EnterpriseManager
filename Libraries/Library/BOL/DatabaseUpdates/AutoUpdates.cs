...
{
    [Serializable]
    public sealed class AutoUpdates : BaseCollection
    {
        ...
        {
            DAL.FirebirdDB.AutoUpdateCreate(autoUpdate);
        }

        public static void Delete(AutoUpdate autoUpdate)
        {
            DAL.FirebirdDB.AutoUpdateDelete(autoUpdate);
        }
        ...
        /// <returns>AutoUpdate object</returns>
        public AutoUpdate this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, AutoUpdate value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(AutoUpdate value)
        {
            List.Remove(value);
        }
