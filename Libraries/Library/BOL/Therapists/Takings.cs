...
{
    [Serializable]
    public sealed class Takings : BaseCollection
    {
        #region Generic CollectionBase Code

        #region Properties

        public TherapistTakings this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, TherapistTakings value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(TherapistTakings value)
        {
            List.Remove(value);
        }
