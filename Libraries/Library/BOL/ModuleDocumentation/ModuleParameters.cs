...
{
    [Serializable]
    public sealed class ModuleParameters : BaseCollection
    {
        #region Generic CollectionBase Code

        #region Properties

        public ModuleParameter this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, ModuleParameter value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(ModuleParameter value)
        {
            List.Remove(value);
        }
