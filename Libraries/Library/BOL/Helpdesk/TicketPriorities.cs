...
{
    [Serializable]
    public sealed class TicketPriorities : BaseCollection
    {
        ...
        public TicketPriority this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, TicketPriority value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(TicketPriority value)
        {
            List.Remove(value);
        }
