...
using Heavenskincare.Library.BOL.Therapists;
using Heavenskincare.Library.BOL.Users;

namespace Heavenskincare.Library.BOL.Appointments
{
    [Serializable]
    public class AppointmentOptions
    {
        ...
        public AppointmentOptions(int EmployeeID, string EmployeeName, bool AllowMonday, bool AllowTuesday, bool AllowWednesday, bool AllowThursday,
        ...
        {
            return (DAL.DALHelper.GetDatabase().AppointmentOptionsCreate(Employee));
        }

        public static void Delete(User Employee)
        {
            DAL.DALHelper.GetDatabase().AppointmentOptionsDelete(Employee);
        }

        public static AppointmentOptions Get(User Employee)
        {
            return (DAL.DALHelper.GetDatabase().AppointmentOptionsGet(Employee.ID));
        }
