...
{
    [Serializable]
    public sealed class AppointmentChanges : BaseCollection
    {
        ...
        public AppointmentChangeItem this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, AppointmentChangeItem value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(AppointmentChangeItem value)
        {
            List.Remove(value);
        }
