...
{
    [Serializable]
    public sealed class AffiliateProducts : BaseCollection
    {
        ...
        public AffiliateProduct this[int Index]
        {
            get
            {
        ...
        /// <param name="value"></param>
        public void Insert(int index, AffiliateProduct value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Remove(AffiliateProduct value)
        {
            List.Remove(value);
        }
