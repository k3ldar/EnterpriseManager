...
{
    public sealed class RoutineMaintenance
    {
        ...
        public void RunArchiveLogData()
        {
            try
            {
                ...
                {
                    lib.WebsiteAdministration.RoutineMaintenance(lib.RoutineMaintenanceType.ArchiveLogs);
                }
            }
            catch (Exception err)
            {
        ...
        public void RunCampaigns()
        {
            try
            {
                if (WebsiteSettings.Maintenance.AllowRoutineMaintenance)
                {
                    lib.WebsiteAdministration.RoutineMaintenance(lib.RoutineMaintenanceType.Campaign);
                }
            }
            catch (Exception err)
            {
        ...
        private void UpdateDistributorDetails()
        {
            try
            {
                lib.LibraryHelperClass.SettingsSetMeta("SITE.URL", WebsiteSettings.RootURL);
                lib.LibraryHelperClass.SettingsSetMeta("SITE.ADDRESS", 
                ...
                lib.LibraryHelperClass.SettingsSetMeta("SITE.TELEPHONE", 
        ...
        {
            lib.LibraryHelperClass Web = new lib.LibraryHelperClass();
